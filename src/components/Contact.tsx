...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="grid min-h-screen w-full place-items-center border-t border-gray-800 bg-[#030712] px-4 py-10 sm:py-16 lg:py-24"
    >
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-start gap-12 md:grid-cols-2">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex items-center gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-blue-900 text-blue-500">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-sm font-semibold text-white transition-colors hover:text-blue-500"
                >
          ...
          <div className="flex gap-4 pt-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-700 text-gray-500 transition-colors hover:border-blue-500 hover:text-blue-500"
            >
        ...
        <div className="rounded-2xl border border-gray-700 bg-gray-800 p-8">
          {submitted ? (
            ...
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-blue-900">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="rounded-lg border border-gray-600 bg-gray-900 px-4 py-2.5 text-sm text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                  />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-bold tracking-wide text-gray-300 uppercase">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  name="service"
                  required
                  className="rounded-lg border border-gray-600 bg-gray-900 px-4 py-2.5 text-sm text-white focus:ring-2 focus:ring-blue-500 focus:outline-none"
                >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  className="resize-none rounded-lg border border-gray-600 bg-gray-900 px-4 py-2.5 text-sm text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                />
              </div>
