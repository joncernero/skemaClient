      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          <div className="mx-auto max-w-sm lg:max-w-none">
            <p className="mt-4 text-center text-gray-400 lg:text-left lg:text-lg">
              Black Wren Digital builds websites, APIs, and custom applications
              for businesses ready to grow. Based in Indianapolis, we deliver
              agency-quality work at freelancer prices — fast, local, and built
              around your goals.
            </p>
        ...
        <div className="mt-16 border-t border-gray-800 pt-8">
          <p className="text-center text-xs/relaxed text-gray-400">
            © Black Wren Digital {new Date().getFullYear()}. All rights
            reserved.
          </p>
        </div>
      </div>
